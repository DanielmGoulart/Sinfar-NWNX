...
public:
    ...
    void Load( FILE* input , bool bMerge = false );
...
public:
    ...
    public:
        ...
        FILE* operator()(FILE* input) const
        {
...
public:
    ...
    public:
		...
		std::string GetKeyValue(const std::string& sKey, const std::string& sDefaultValue=std::string()) const;
